...
func Tips() {
	...
	tips := []string{
		...
		"アップデートする必要はありません！ただし、強くお勧めします。",
		"You don't need to update! It's highly recommended though.",

		"どうか健康を危険にさらさないでください……心からそう願っています。",
		"Please don't risk your health... Genuinely.",
