...
Do not use this tool with official SEGA assets. I do not endorse brekaing Copyright Law.
...
```
Sono-Overlay:
- Made by Nexint (https://nexint.ca/), forked from TootieJin (https://tootiejin.com)
- Assets are made by Nexint (https://nexint.ca/)
